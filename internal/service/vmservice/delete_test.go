...
func TestDeleteVM_SuccessNotFound(t *testing.T) {
	...
	proxmoxClient.EXPECT().DeleteVM(context.TODO(), "node1", int64(123), string(machineScope.ProxmoxMachine.UID)).Return(nil, errors.New("vm does not exist: some reason")).Once()
